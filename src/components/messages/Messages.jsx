  ...
  return (
    ...
    <div className={styles.messages}>
      ...
      <p className={styles.messages__content}>
        Not 100% sure it’s a perfect fit? We offer free shipping, exchanges, and
        returns both ways on all orders in the U.S.
      </p>
      <h3 className={styles.messages__title}>Serving you</h3>
      <p className={styles.messages__content}>
        If you have comments, questions, or issues, our Ninjas are always on
        call. Need help? Contact a Ninja.
      </p>
